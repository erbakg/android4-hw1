...
class HomeProjectsFragment : Fragment() {
    private var _binding: FragmentHomeProjectsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHomeProjectsBinding.inflate(inflater, container, false)
    ...
    private fun initListeners() {
        DatabaseManager.projectDao.getProjectsByType(ProjectTypes.HOME).observe(viewLifecycleOwner) { data ->
